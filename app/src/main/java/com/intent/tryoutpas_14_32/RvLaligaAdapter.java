...
public class RvLaligaAdapter extends RecyclerView.Adapter<RvLaligaAdapter.ViewHolder> {

    List<ModelClass> teamList;

    public RvLaligaAdapter(LaligaFragment laligaList, List<ModelClass> teamList) {
